...
<form method="post" action="<@ofbizUrl>createcompany${previousParams}</@ofbizUrl>" id="newuserform" name="newuserform">
  ...
  <fieldset class="col">
    ...
    <div>
      ...
      <input type="text" name="USER_ADDRESS1" id="USER_ADDRESS1" value="${requestParameters.USER_ADDRESS1?if_exists}" />
    </div>
    ...
    <div>
      ...
      <input type="text" name="USER_CITY" id="USER_CITY" value="${requestParameters.USER_CITY?if_exists}" />
    </div>
...
-->
      ...
      <tbody>
        <tr>
          ...
          <td><input type="text" name="HOME_COUNTRY" size="5" value="${requestParameters.HOME_COUNTRY?if_exists}" /></td>
          <td><input type="text" name="HOME_AREA" size="5" value="${requestParameters.HOME_AREA?if_exists}" /></td>
          <td><input type="text" name="HOME_CONTACT" value="${requestParameters.HOME_?if_exists}" /></td>
          <td><input type="text" name="HOME_EXT" size="6" value="${requestParameters.HOME_EXT?if_exists}"/></td>
<!--
          <td>
...
-->
        ...
        <tr>
          ...
          <td><input type="text" name="USER_WORK_COUNTRY" size="5" value="${requestParameters.USER_WORK_COUNTRY?if_exists}" /></td>
...
-->
        ...
        <tr>
          ...
          <td><input type="text" name="USER_MOBILE_COUNTRY" size="5" value="${requestParameters.USER_MOBILE_COUNTRY?if_exists}" /></td>
          <td><input type="text" name="USER_MOBILE_AREA" size="5" value="${requestParameters.USER_MOBILE_AREA?if_exists}" /></td>
          <td><input type="text" name="USER_MOBILE_CONTACT" value="${requestParameters.USER_MOBILE_CONTACT?if_exists}" /></td>
          <td></td>
<!--
          <td>
...
-->
  ...
  <fieldset class="col">
    ...
    <div>
      ...
      <input type="text" name="USER_EMAIL" id="USER_EMAIL" value="${requestParameters.USER_EMAIL?if_exists}" onchange="changeEmail()" onkeyup="changeEmail()" />
    </div>
<!--
    <div>
