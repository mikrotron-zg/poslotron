...
if (product) {
    ...
    // add all product categories; we use them to filter out products not belonging to any category
    context.categories = product.getRelated("ProductCategoryMember", null, null, false)
}
