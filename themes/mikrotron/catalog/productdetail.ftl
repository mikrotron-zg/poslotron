      ...
      <#if category?exists>
        ...
        <div id="productDetailBox">
          ...
          <#if price.listPrice?exists && price.price?exists && price.price &lt; price.listPrice>
            <div>${uiLabelMap.ProductListPrice}: <span class="basePrice"><@ofbizCurrency amount=price.listPrice isoCode=price.currencyUsed /><#if price.currencyUsed == "HRK">&nbsp;(<@ofbizCurrency amount=price.listPrice/exchangeRate isoCode=euro/>)</#if></span></div>
          </#if>
          ...
          <#if price.listPrice?exists && price.price?exists && price.price &lt; price.listPrice>
            ...
            <div>${uiLabelMap.OrderSave}: <span class="basePrice"><@ofbizCurrency amount=priceSaved isoCode=price.currencyUsed /><#if price.currencyUsed == "HRK">&nbsp;(<@ofbizCurrency amount=priceSaved/exchangeRate isoCode=euro/>)</#if> (${percentSaved?int}%)</span></div>
          </#if>
        ...
        <#if productImageList?has_content>
            ...
            <div id="detailImageBox">
                ...
                <#if productLargeImageUrl?string?has_content>
                    <img id="detailImage" src="<@ofbizContentUrl>${contentPathPrefix?if_exists}${productLargeImageUrl?if_exists}</@ofbizContentUrl>" name="mainImage" vspace="5" hspace="5" alt="" />
        ...
        <#else>
            ...
            <div id="additionalImageBox">
                <#if productAdditionalImage1?string?has_content>
                    <div class="additionalImage">
                        <a href="javascript:void(0);" swapDetail="<@ofbizContentUrl>${productAdditionalImage1}</@ofbizContentUrl>"><img src="<@ofbizContentUrl>${productAdditionalImage1}</@ofbizContentUrl>" vspace="5" hspace="5" alt="" /></a>
                    </div>
                </#if>
                <#if productAdditionalImage2?string?has_content>
                    <div class="additionalImage">
                        <a href="javascript:void(0);" swapDetail="<@ofbizContentUrl>${productAdditionalImage2}</@ofbizContentUrl>"><img src="<@ofbizContentUrl>${productAdditionalImage2}</@ofbizContentUrl>" vspace="5" hspace="5" alt="" /></a>
                    </div>
                </#if>
                <#if productAdditionalImage3?string?has_content>
                    <div class="additionalImage">
                        <a href="javascript:void(0);" swapDetail="<@ofbizContentUrl>${productAdditionalImage3}</@ofbizContentUrl>"><img src="<@ofbizContentUrl>${productAdditionalImage3}</@ofbizContentUrl>" vspace="5" hspace="5" alt="" /></a>
                    </div>
                </#if>
                <#if productAdditionalImage4?string?has_content>
                    <div class="additionalImage">
                        <a href="javascript:void(0);" swapDetail="<@ofbizContentUrl>${productAdditionalImage4}</@ofbizContentUrl>"><img src="<@ofbizContentUrl>${productAdditionalImage4}</@ofbizContentUrl>" vspace="5" hspace="5" alt="" /></a>
                    </div>
                </#if>
            </div>
        </#if>
      ...
      <#if downloadProductContentAndInfoList?has_content>
        <div id="download-files">
          ...
          <#list downloadProductContentAndInfoList as downloadProductContentAndInfo>
            <div>
            <#if downloadProductContentAndInfo.dataResourceId?has_content>
            <a href="/content/control/ViewSimpleContent?dataResourceId=${downloadProductContentAndInfo.dataResourceId}">
            </#if>
            ${downloadProductContentAndInfo.contentName?if_exists}
            <#if downloadProductContentAndInfo.description?has_content> - ${downloadProductContentAndInfo.description}</#if>
            <#if downloadProductContentAndInfo.dataResourceId?has_content>
            </a>
            </#if>
            </div>
